...
export function StayRoanokeLogo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', lineHeight: 1 }}>
      <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 700, fontSize: '28px', color: '#1B4F72', whiteSpace: 'nowrap' }}>StayRoan</span>
      <svg width="28" height="38" viewBox="0 0 56 76" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', margin: '0 -1px', flexShrink: 0 }}>
        <circle cx="28" cy="26" r="26" fill="#1B4F72"/>
        <polygon points="28,72 14,50 42,50" fill="#1B4F72"/>
        <circle cx="28" cy="26" r="20" fill="white"/>
        <clipPath id="pc"><circle cx="28" cy="26" r="19"/></clipPath>
        ...
        <polygon points="28,1 30,8 37,8 31.5,12.5 33.5,19.5 28,15.5 22.5,19.5 24.5,12.5 19,8 26,8" fill="none" stroke="#C8A97A" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
      <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 700, fontSize: '28px', color: '#1B4F72', whiteSpace: 'nowrap' }}>ke</span>
    </div>
  )
}
