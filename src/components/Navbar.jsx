...
export function StayRoanokeLogo() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', lineHeight: 1 }}>
      ...
      <svg width="28" height="38" viewBox="0 0 56 76" xmlns="http://www.w3.org/2000/svg"
        ...
        <polygon points="28,1 30,8 37,8 31.5,12.5 33.5,19.5 28,15.5 22.5,19.5 24.5,12.5 19,8 26,8"
          fill="none" stroke="#C8A97A" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
      <span style={{
        fontFamily: "'Playfair Display', Georgia, 'Times New Roman', serif",
        fontWeight: 700,
