  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;border-radius:12px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.12);">
      ...
      <tr><td style="background-color:#ffffff;padding:40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:30px;">
          <tr><td style="padding:11px 0;border-bottom:1px solid #f3f4f6;font-size:14px;color:#4b5563;line-height:1.6;">&#128273;&nbsp;&nbsp;<strong>Get your door code.</strong> Complete the <a href="${guestPortalUrl}" style="color:#1B4F72;font-weight:600;text-decoration:underline;">check-in form</a> in your guest portal — your access code won't be released until it's filled out.</td></tr>
